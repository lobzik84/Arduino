...
void setup() {     
  ...
  mySwitch433.enableReceive(RX_315_INT);
  mySwitch433.enableTransmit(TX_433_PIN);
...
void loop() {
    ...
    {
      response("433_RX:");
      responseln(String(mySwitch433.getReceivedValue(), DEC));
      mySwitch433.resetAvailable();
    }
   /* if (mySwitch315.available()) 
    {
      response("315_RX:");
      responseln(String(mySwitch315.getReceivedValue(), DEC));
